...
document.write('<div id="interContainer">'+this.defineheader+'<div id="interContent"><p style="margin: 5px 10px"><a target="_blank" href="http://impactsurvey.org/libselect/index.php?fscs=' + fscs + '&utm_source=library&utm_medium=interstitial&utm_term=' + fscs + '&utm_campaign=pilot"><img title="Click here to take our survey" alt="Click here to take our survey" src="http://impactsurvey.org/sites/impactsurvey.org/files/overlay/impactbanner.jpg" width="631" height="194" style="border: 1px solid gray" /></a><br />How do you use the library\'s computers and Internet access?</p><p style="margin: 5px 10px"> <b style="font-size: 110%"><a target="_blank" href="http://impactsurvey.org/libselect/index.php?fscs=' + fscs + '&utm_source=library&utm_medium=interstitial&utm_term=' + fscs + '&utm_campaign=pilot"><span style="color:#0000FF">Take our survey</span></a> and help your library evaluate its technology services!</b></p></div></div><div id="interVeil"></div>')
